...
export default function Header() {
    return (
        <header className="w-full h-16 bg-white/80 backdrop-blur-md border-b border-gray-200/50 shadow-sm sticky top-0 z-50">
            <div className="mx-auto container">
                <div className="flex items-center justify-between h-16 px-4 sm:px-0">
                    ...
                    <div className="flex items-center space-x-4 sm:space-x-8">
                        ...
                        <div className="flex items-center space-x-2 sm:space-x-3 group">
                            <div className="relative">
                                <Image 
                                    src="/hubters-webai-logo-orange.svg" 
                                    alt="Hubters WebAI logo" 
                                    width={32}
                                    height={32}
                            ...
                            <h1 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 tracking-tight cursor-pointer" onClick={()=>{
                                ...
                                <span className="hidden sm:inline">Hubters{' '}</span>
                    ...
                    <div className="flex items-center space-x-2 sm:space-x-4">
                        ...
                        <button 
                            onClick={()=>{
                                window.open("https://webai.hubtersai.com", "_blank")
                            }} 
